...
type Book struct {
	...
	Price  *wrapperspb.Int64Value `protobuf:"bytes,3,opt,name=price,proto3" json:"price,omitempty"` // 不要这么改，最好增加一个，防止版本错乱
...
type UpdateBookRequest struct {
	...
	Book       *Book                  `protobuf:"bytes,2,opt,name=book,proto3" json:"book,omitempty"`                               // 需要更新的书籍信息
	UpdateMask *fieldmaskpb.FieldMask `protobuf:"bytes,3,opt,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"` // 需要更新的字段，每次请求获取的更新字段可能不同
}
...
var file_notice_proto_rawDesc = []byte{
	...
	0x5a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2f,
